...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 25, 2021 at 02:34 PM
...
INSERT INTO `logs`(`log_id`, `ip_address`, `event_type`, `event_details`) VALUES 
(1, '192.168.56.1', 'User Registration', 'cbaldry registered an account'),
(2, '192.168.56.1', 'Login', 'cbaldry logged in'),
(3, '192.168.56.2', 'Login Attempt', 'Failed login attempt with username of dbaldry'),
(4, '192.168.56.2', 'Login', 'dbaldry logged in'),
(5, '192.168.56.2', 'Access Level', 'Changed dbaldry changed access level of cbaldry to admin'),
(6, '192.168.56.2', 'Logout', 'dbaldry logged out'),
(7, '192.168.56.1', 'Movie Added', 'Jaws (1975) added by cbaldry'),
(8, '192.168.56.1', 'Movie Deleted', 'Jaws (1975) deleted by cbaldry');
-- phpMyAdmin SQL Dump
-- version 5.0.4
-- https://www.phpmyadmin.net/
--
-- Host: 127.0.0.1
-- Generation Time: Nov 01, 2021 at 02:53 AM
-- Server version: 10.4.17-MariaDB
-- PHP Version: 7.4.15
...
INSERT INTO `upvotes` (`discussion_id`, `username`) VALUES
(1, 'cbaldry'),
(2, 'lbaldry'),
(2, 'rbaldry'),
(5, 'mbaldry'),
